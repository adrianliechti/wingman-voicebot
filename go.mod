module github.com/adrianliechti/wingman-voicebot

go 1.24.2

require (
	github.com/adrianliechti/go-cli v0.0.5
	github.com/adrianliechti/wingman v0.0.0-20250421192309-73df4853f2fa
	github.com/adrianliechti/wingman-cli v0.1.1-0.20250421185936-cdbe6c6cfa1c
